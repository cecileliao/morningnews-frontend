...
function Header() {
	...
	const handleRegister = () => {
		fetch('https://morningnews-backend-cecileliao.vercel.app/users/signup', {
			method: 'POST',
	...
	const handleConnection = () => {
		...
		fetch('https://morningnews-backend-cecileliao.vercel.app/users/signin', {
			method: 'POST',
			headers: { 'Content-Type': 'application/json' },
	...
	return (
		<header className={styles.header}>
			...
			<div className={styles.linkContainer}>
				...
				<FontAwesomeIcon onClick={() => showHiddenArticlesClick()} icon={faEye} className={styles.bookmarkIcon} />
			</div>
